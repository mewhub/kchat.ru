...
var mySettings = {
	...
	markupSet:  [
		...
		{name:'Фото из Интернета', replaceWith:'<img src="[![Адрес фото:!:http://]!]" alt="" />', className: 'btnImg'},
		...
		{name:'Скрытый текст', key:'H', openWith:'<spoiler>', closeWith:'</spoiler>', className: 'btnSpoiler'},
	]
}
